...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=5.0cm]{logos/Tufts_University_wordmark_white.pdf}}; % also try shield-white.eps
      \node [anchor=north east, inner sep=3cm] at ([xshift=0.0cm,yshift=1.5cm]current page.north east)
      {\includegraphics[height=5.0cm]{logos/mathworks_logo_white.pdf}};
    \end{tikzpicture}
}
